    ...
    return(
        <Contenair>
            <div>
                ...
                <p>Rejoignez-nous pour augmenter votre visibilité en ligne. 
                    Vous aurez accès à encore plus de clients qui cherchent 
                    à déguster vos plats savoureux à la maison.</p>
                <button>Intégrer la plateforme</button>
            </div>
        </Contenair>
    )
}
